    ...
    return (
        <div className='container my-5'>
            <button className="logout" onClick={logout}>
                <LogoutIcon style={{"fontSize":"50px"}} ></LogoutIcon>
            </button>
                    ...
                    <div className='col-md-12 col-lg-8'>
                        <div className='price-box'>
                            <div className='grouped-box'>
                                <button
                                    onClick={planSelect1}
                                    className={`pricing-box ${plan === 1 ? 'pricing-box-active' : ''
                                        }`}
                                >
                                    Mobile
                                </button>
                            ...
                            <div className='grouped-box'>
                                <button
                                    onClick={planSelect2}
                                    className={`pricing-box ${plan === 2 ? 'pricing-box-active' : ''
                                        }`}
                                >
                                    Basic
                                </button>
                            ...
                            <div className='grouped-box'>
                                <button
                                    onClick={planSelect3}
                                    className={`pricing-box ${plan === 3 ? 'pricing-box-active' : ''
                                        }`}
                                >
                                    Standard
                                </button>
                            ...
                            <div className='grouped-box'>
                                <button
                                    onClick={planSelect4}
                                    className={`pricing-box ${plan === 4 ? 'pricing-box-active' : ''
                                        }`}
                                >
                                    Premium
                                </button>
